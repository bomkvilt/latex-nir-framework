...
% G #7 - head code p. 1
% G #8 - head code p. 2+
% D #9 - code before tabularx
% >>
\NewDocumentEnvironment{sectable}{ O{\textwidth} m d<> s O{} O{} G{} G{#7} D(){\small}} {
    ...
    \xltabular{#1}{#2}
        ...
        \hline #7 \hline \endfirsthead
        \hline #8 \hline \endhead
} {
    \endxltabular
    \bigskip
}
...
% D #8 - code before tabularx
% >>
\NewDocumentEnvironment{atomictable}{ O{\textwidth} m d<> s O{} O{} O{H} D(){\small}}
{
    \tl_clear_new:N \@@@caption
    \@@sections@tabs@generateCaption:Nnnnnn \@@@caption {\caption}{#6}{#3}{#4}{#5}
