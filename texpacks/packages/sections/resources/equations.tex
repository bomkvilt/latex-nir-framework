...
\cs_new:Npn \@@sections@eqns@load:Nnn #1 #2 #3
{
...
%  #4       - equatoin's label
\cs_new:Npn \@@sections@eqns@makeLabel:Nnnn #1 #2 #3 #4
{
    \tl_if_novalue:nTF {#4}
    {
        \tl_set:Nn #1 {#4}
...
\cs_new:Npn \@@sections@eqns@input:nnnn #1 #2 #3 #4
{{
    \input{#1}
