...
% #2 - label prefix
% #3 - subpath
\@@sections@res@newResourceType{eqs}{eqs:}{/eqns}
...
{{
    % path to equation
    \tl_clear_new:N \@@@path
    \@@sections@res@load:Nnnn \@@@path {eqs}{pathTable}{#1}
    \tl_set:Nx \@@@path {\@@@path/#2.tex}

    % create a base equation label
    \tl_clear_new:N \@@@label
    \@@sections@res@makeLabel:Nnnnn \@@@label {eqs}{#1}{#3}{#4}
...
{
    \@@sections@res@addSublabel:nnn {eqs}{#1}{#2}
}
...
{
    \@@sections@res@ref:nnnnn {eqs}{#1}{#2}{#3}{#4}
}
