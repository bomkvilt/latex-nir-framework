...
%  #3       - b use global label names
%  #4       - equatoin's label
\cs_new_protected:Npn \@@sections@eqns@makeLabels:Nnnn #1 #2 #3 #4
{
    \seq_clear_new:N \@@@labels
    \tl_clear_new:N  \@@@label
    \clist_map_inline:nn { #4 }
    {
        \@@sections@eqns@makeLabel:Nnnn \@@@label {#2}{#3}{##1}
...
{{
    ...
    \@@sections@eqns@makeLabels:Nnnn \@@@labels {#1}{#2}{#3}
    \@@sections@cmn@ref:NVn \@@sections@eqns@labelDB \@@@labels {#4}
}}
