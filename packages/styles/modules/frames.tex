...
% -----------------| frames.end
    ...
    \NewDocumentCommand{\frames@stamp@a_four_one}{ s }
    {
        \frames@render
        {
            ...
            \frames@cell
            { % x0  ; y0 ; dx  ; dy ; text
                0   ; 25 ; 7   ; 5  ; \small\text{Лит.}     ,
                7   ; 25 ; 10  ; 5  ; \small\text{Изм.}     ,
                17  ; 25 ; 23  ; 5  ; \small\text{№~докум.} ,
                40  ; 25 ; 15  ; 5  ; \small\text{Подп.}    ,
                55  ; 25 ; 10  ; 5  ; \small\text{Дата}     ,
                135 ; 20 ; 15  ; 5  ; \small\text{Лит.}     ,
                150 ; 20 ; 15  ; 5  ; \small\text{Лист}     ,
                165 ; 20 ; 20  ; 5  ; \small\text{Листов}   ,
                65  ; 25 ; 110 ; 15 ; \large\documentName   ,
                150 ; 15 ; 15  ; 5  ; \thepage
            }
        }
    }
    ...
    \NewDocumentCommand{\frames@stamp@a_four_n}{ s }
    {
        \frames@render
        {
            ...
            \frames@cell
            { % x0  ; y0 ; dx  ; dy ; text
                0   ; 0  ; 7   ; 5  ; \small\text{Лит.}     ,
                7   ; 0  ; 10  ; 5  ; \small\text{Изм.}     ,
                17  ; 0  ; 23  ; 5  ; \small\text{№~докум.} ,
                40  ; 0  ; 15  ; 5  ; \small\text{Подп.}    ,
                55  ; 0  ; 10  ; 5  ; \small\text{Дата}     ,
                175 ; 10 ; 10  ; 5  ; \small\text{Лист}     ,
                65  ; 0  ; 110 ; 15 ; \large\documentName   ,
                175 ; 0  ; 10  ; 10 ; \normalsize\thepage
            }
        }
    }
