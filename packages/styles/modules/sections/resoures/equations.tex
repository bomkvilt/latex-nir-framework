...
{{
    ...
    { \tl_set:Nx \l@label_tl {\sections@eqs@partPrefix#4} }
    ...
    { \printEquations }
    { \printEquations[\sections@eqsPrefix\l@label_tl] }
...
{{
    \tl_set:NV \l@prefix_tl \sections@eqsPrefix
    \bool_if:nF {#1}
    { 
    ...
    \secs_addReference:Nn{\l@prefix_tl}{\l@label_tl}
}}
