...
\NewDocumentCommand{\sections@addAppendix}{ m }
{
    ...
    \seq_gpush:Nx \sections@reg@appendixPaths_seq {#1}
}
...
\NewDocumentCommand{\addAppendices}{ s }
{
    \seq_map_inline:Nn \sections@reg@appendixPaths_seq
    {
        \typeout{+++++++|##1/\sections@const@appendix_str.tex|}
        \include{##1/\sections@const@appendix_str}
    }
}
