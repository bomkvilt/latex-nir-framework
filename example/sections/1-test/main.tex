...
Общая ссылка на большее количество формул: \req{test-1, test-2, test-0.1, test-0.2, 
test-0.3, test-0.4, test-0.5}. Как видно происходит группировка ссылкок в диапазоны.
...
\IncludeFigure{knuth1}[knuth2][Вот это подпись под рисунком][height=3cm]\bigbreak
\IncludeFigure{knuth1}[knuth3][][height=1cm]\bigbreak
\IncludeFigure{knuth1}[knuth4][][height=1cm]\bigbreak
...
\pagebreak
\section*{Многофайловость}
\IncludeSubsection{part1}
\IncludeSubsection{indir/part2}
